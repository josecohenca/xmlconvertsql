...
namespace mASN1_tests.SampleClasses {
	...
	/// </summary>
	public class test_TAG_IMPLICIT:ASN1ImplicitTag 
	{
		public bool val;
		
		public test_TAG_IMPLICIT() 
		{
		...
		/// <summary>
		/// Registering components is a convenience, not really 
		/// necessary.
		/// </summary>
		public override void RegisterComponents()
		{
			this.val = (this.underObject as ASN1Boolean).val;
		}

	}	

	public class test_TAG_IMPLICIT_type:ASN1ImplicitTag_type 
	{
		public override ASN1Object Instance()
		{
			return new test_TAG_IMPLICIT();
		}
