...
namespace mASN1_tests.SampleClasses {
	...
	public class test_SET_OF:ASN1SetOf
	{
		public test_SET_OF() 
		{
			this.Max_Elements = 6;
	...
	public class test_SET_OF_type:ASN1SetOf_type 
	{
		public test_SET_OF_type() 
		{
			this.type = new ASN1ObjectIdentifier_type();  /* -- ovaj je nuzan... */
			this.Init();
		}
