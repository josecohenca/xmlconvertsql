...
namespace mASN1_tests.SampleClasses {
	...
	///     AType::=SEQUENCE OF OBJECT IDENTIFIER
	/// </summary>
	public class test_SEQUENCE_OF:ASN1SequenceOf 
	{
		public test_SEQUENCE_OF() 
		{
			this.type = new ASN1ObjectIdentifier_type();
		}
	}

	public class test_SEQUENCE_OF_type: ASN1SequenceOf_type 
	{
		public test_SEQUENCE_OF_type() 
		{
			this.type = new ASN1ObjectIdentifier_type();
		}
