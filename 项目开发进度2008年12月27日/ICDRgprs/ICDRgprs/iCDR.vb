...
Public Class iCDR
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim serialNum = reader.ReadLine()
        Dim machineNum = reader.ReadLine()
        Dim regNum = reader.ReadLine()
        reader.Close()
        ...
        Me.WindowState = FormWindowState.Maximized
    End Sub
    Private Sub iCDR_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        TabControl1.Width = Me.Width
        TabControl1.Height = Me.Height - 24 - 52
        DataGridView1.Width = Me.Width - 15
        DataGridView1.Height = Me.Height - 35 - 52 - 50
        ListBox1.Width = Me.Width - 15
        ListBox1.Height = Me.Height - 35 - 52 - 50
        DataGridView2.Width = Me.Width - 15
        DataGridView2.Height = Me.Height - 35 - 52 - 50
        TreeView1.Height = Me.Height - 52 - 50
        DataGridView3.Height = Me.Height - 60 - 52 - 50
        DataGridView3.Width = Me.Width - 20 - 395
        TextBox1.Width = Me.Width - 20 - 395
        TextBox2.Width = Me.Width - 20 - 395

        RichTextBox1.Location = New Size(0, 5)
        RichTextBox1.Width = Me.Width - 15
        RichTextBox2.Location = New Size(0, 10 + RichTextBox1.Height)
        RichTextBox2.Width = Me.Width - 15
        RichTextBox2.Height = Me.Height - RichTextBox1.Height - 10 - 52 - 50

        'AxMSChart1.Width = Me.Width - 15
        'AxMSChart1.Height = Me.Height - 52 - 50
    End Sub
    Private Sub TreeView1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TreeView1.Click
        ...
        Try
            ...
            If Not Node1 Is Nothing Then
                ...
                End With
            End If
            'AxMSChart1.chartType = MSChartLib.VtChChartType.VtChChartType2dBar
            'AxMSChart1.DataSource = rs
            'AxMSChart1.TitleText = rs(0).Name
    ...
    Private Sub RadioButton6_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadioButton6.CheckedChanged
        ToolStripTextBox1.Text = "select top 100 * from ggsnpdp"
    End Sub
...
LnextFile:
    ...
    Private Sub ToolStripComboBox1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ToolStripComboBox1.TextChanged
        Try
            'AxMSChart1.chartType = ToolStripComboBox1.SelectedIndex
        Catch
        Finally
        End Try
    End Sub
    '////////////////////////////////////////////////////////////////////////////////////////////////////
    Private Sub HexstringToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles HexstringToolStripMenuItem.Click
        Dim str As String '= "3B 20 4D 53 49 45 20 36"
        str = Trim(RichTextBox1.SelectedText)
        Dim strs() As String = str.Split(" ")
        Dim bytes(strs.Length) As Byte
        Try
            For i As Integer = 0 To strs.Length - 1
                bytes(i) = Convert.ToByte(Convert.ToInt32(strs(i), 16))
            Next
            Dim result As String = Encoding.UTF8.GetString(bytes)
    ...
    Private Function MakeDataTable() As DataTable
        ...
        For i = 0 To DataGridView3.RowCount - 2
            dr = dt.NewRow
            dr("X") = i + 1
            dr("Y") = DataGridView3.Rows(i).Cells(1).Value
            dr("Text") = DataGridView3.Rows(i).Cells(0).Value
            dt.Rows.Add(dr)
        Next
        Return dt
    End Function
    ...
    Private Sub 话单图表CToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 话单图表CToolStripMenuItem.Click
        For i = 0 To 6
            If TabControl1.TabPages(i).Name = "话单图表" Then
                TabControl1.SelectedIndex = i
            End If
        Next
    End Sub

    Private Sub 图表工具TToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 图表工具TToolStripMenuItem.Click
        For i = 0 To 6
            If TabControl1.TabPages(i).Name = "图表工具" Then
                TabControl1.SelectedIndex = i
            End If
        Next
    End Sub
